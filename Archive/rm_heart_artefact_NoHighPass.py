...
from PCA_OBS_NoHighPass import *
from get_conditioninfo import *
from get_channels import *


def rm_heart_artefact_NoHighPass(subject, condition, srmr_nr, sampling_rate, pchip):
    ...
    save_path = "/data/pt_02569/tmp_data/ecg_rm_py_NoHighPass/"+subject_id+"/esg/prepro/"
    ...
    for ch in debug_channel:
        ...
        raw.copy().apply_function(PCA_OBS_NoHighPass, picks=[ch], **PCA_OBS_kwargs)
    ...
    raw.apply_function(PCA_OBS_NoHighPass, picks=esg_chans, **PCA_OBS_kwargs, n_jobs=len(esg_chans))
