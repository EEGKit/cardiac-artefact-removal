...
# Specifying an exact colorbar axis
...
def plot_esg_isopotential(chanvalues, colorbar_axes, gridsize, chan_pos_grid, labels, colorbar, time, axis):
    ...
    #     plt.colorbar(cf, ax=axis[1], label='Amplitude (\u03BCV)', ticks=ticks)
...
def mrmr_esg_isopotentialplot_cbar(subjects, chanvalues, colorbar_axes, chan_labels, colorbar, time, axis):
    ...
    cf = plot_esg_isopotential(ordered_chanvalues, colorbar_axes, grid_size, grid_pos, labels, colorbar, time, axis)
